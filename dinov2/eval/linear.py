...
class MultiLayerClassifier(nn.Module):
    """Multi-layer linear classifier on top of frozen features"""

    def __init__(self, out_dim, hidden_dim, use_n_blocks, use_avgpool, num_classes=1000):
        super().__init__()
        self.out_dim = out_dim
    ...
    def forward(self, x_tokens_list):
        # Create input using provided tokens
        output = create_linear_input(x_tokens_list, self.use_n_blocks, self.use_avgpool)
...
class MultiLayer4Classifier(nn.Module):
    """4-layer linear classifier on top of frozen features"""

    def __init__(self, out_dim, hidden_dim1, hidden_dim2, hidden_dim3, use_n_blocks, use_avgpool, num_classes=1000):
        super().__init__()
        self.out_dim = out_dim
        ...
        # Adding multiple layers
        self.linear1 = nn.Linear(out_dim, hidden_dim1)
        self.linear2 = nn.Linear(hidden_dim1, hidden_dim2)
        self.linear3 = nn.Linear(hidden_dim2, hidden_dim3)
        self.linear4 = nn.Linear(hidden_dim3, num_classes)
        ...
        self.linear2.weight.data.normal_(mean=0.0, std=0.01)
        self.linear2.bias.data.zero_()
        self.linear3.weight.data.normal_(mean=0.0, std=0.01)
        self.linear3.bias.data.zero_()
        self.linear4.weight.data.normal_(mean=0.0, std=0.01)
    ...
    def forward(self, x_tokens_list):
        ...
        # Pass through the layers with ReLU activation in between
        output = self.relu(self.linear1(output))
